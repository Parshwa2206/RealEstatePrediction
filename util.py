...
def load_saved_artifacts2():
    ...
    with open("./artifacts/columns.json", 'r') as f:
        __data_columns = json.load(f)['data_columns']
        __locations = __data_columns[3:]
        __locations2 = __data_columns[3:]

    print("Loading the artifacts is done")

    for item in __locations1:
        __locations2.append(item)
...
if __name__ == '__main__':
    ...
    load_saved_artifacts2()
    print('#Bangalore')
    print(get_location_names())
    print('#Ahmedabad')
    print(get_location_names1())
    print('#Ahmedabad + Bangalore')
    print(get_entire_locations())
    print('#Bangalore')
